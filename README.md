...
1. In **设计工坊 / Design**, start from the canonical draft or clone a saved fly, edit circuit weights and intrinsic parameters, validate the budget, and save an immutable design. Saving opens the training sandbox with your new fly selected. Choose a strategy, objective and finite budget before starting any evaluations; saving alone does not consume simulation time. You can also send a saved fly directly to the Arena.
