...
export type Fly = {id:string;owner:string;designer:string;name:string;color:string;artifact_id:string;created:number;spec:Spec;report:Report;reference_kind?:'wildtype'|'official'|'user'|'ai';release_id?:string|null;submission_channel?:'web'|'api'|'seed';experiment_id?:string|null;experiment_error?:string|null}
