...
export type Season = {id:string;name:string;connectome:{sha256:string;neuron_count:number;edge_count:number;synaptic_contacts:number;circuits:Circuit[]};budget:{points:number};invite_required:boolean;runtime_sha256:string;default_bridge_profile?:string;match_profiles?:MatchProfile[];sensory_profiles?:SensoryProfile[];training_sensory_profiles?:SensoryProfile[];training_fitness_objectives?:{id:string;name:string;ready:boolean}[];gallery_copy_available?:boolean}
