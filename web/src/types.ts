...
export type BrainSample = {circuits:Record<string,number>;top_nodes?:{id:string;activity:number}[];sampled_nodes?:{id:string;activity:number}[];sampling?:{kind:string;count:number;sensory_groups?:Record<string,string[]>}}
