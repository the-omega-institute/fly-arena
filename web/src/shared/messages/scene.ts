export const sceneMessages = {
 ...
 "scene.webglUnavailable": {"en": "WebGL unavailable. Showing the 2D view.", "zh-CN": "WebGL 不可用，已显示 2D 视图。"},
 "scene.contextLost": {"en": "WebGL context lost. Showing the 2D view.", "zh-CN": "WebGL 上下文丢失，已显示 2D 视图。"},
 "scene.rendererFailed": {"en": "3D renderer failed. Showing the 2D view.", "zh-CN": "3D 渲染失败，已显示 2D 视图。"},
 "scene.retry": {"en": "Retry 3D", "zh-CN": "重试 3D"},
 "scene.brainFallback": {"en": "Inspect the selected neuron, local connections and recorded activity in the 2D graph below. Its layout is schematic, not anatomical coordinates; missing activity stays unrecorded.", "zh-CN": "可在下方 2D 连接图中检查所选神经元、局部连接和记录活动。布局仅为示意，不是解剖坐标；缺失活动仍标为未记录。"},
